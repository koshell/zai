...
from . import common, crypt, crypttab, format_block, mount, pacman, partition


def livecd_pacman_gpg_tweaks():
    with open("/etc/pacman.d/gnupg/gpg.conf", "a") as gpg_conf:
        gpg_conf.write("auto-key-retrieve")
    return
...
def main(args):
    ...
    # Partitioning
    partition.Partition_Manager("DEVICE").write_to_disk()
